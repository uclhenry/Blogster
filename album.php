        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-3">
                    <nav>
                        <ul>
                            <img src="./uploads/<?php echo $_GET['profile'] ?>/profile.jpg" alt="Profile Pic" style="width:120px;height 120px;">
                        </ul>
                    </nav>
                </div>
                <div class="col-md-6">
                        ...
                        <div class="caption">
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                    <?php 
                                    $photoDeleteLink = "photoPage.php?profile=".$row["id_user"]."&id_del=".$row["id_photo"]."&del_path=".dirname(__FILE__)."/".$row["file_path"]."&return=album.php&profile=".$row['id_user'];
